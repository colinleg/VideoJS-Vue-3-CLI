<template>
    <div>
        <h1>5eme test: Dimensions et Positionnement + Affichage en fonction du Time (via currentTime() / toggle displayOn / 2 fonctions)
...
export default {
    ...
    mounted(){
        ...
        this.getDimensions(player);
        // console.log(this.player.el())
        // console.log(this.player.el().children[5].style.height);
        ...
        this.initMask();
        this.checkTime();
        // let cbDimensions = player.controlBar.currentDimensions();
        // console.log(cbDimensions)
